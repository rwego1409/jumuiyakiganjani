...
class CreateGeneralSettings_2025_05_27_000000 extends SettingsMigration
{
    public function up(): void
    {
        ...
        $this->migrator->add('general.whatsapp_enabled', true);
        ...
        $this->migrator->add('general.reminder_days', 7);
