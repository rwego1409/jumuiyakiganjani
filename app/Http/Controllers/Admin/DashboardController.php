...
$ongoingEvents = Event::where('status', 'ongoing')->whereDate('start_time', '<=', now())
    ->whereDate('end_time', '>=', now())->count(); // Ensure it includes ongoing events within the range
...
$totalEvents = Event::count();
        ...
        // Total resources
        $totalResources = Resource::count(); // Get total resources
