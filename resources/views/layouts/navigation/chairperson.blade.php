...
<nav x-data="{ 
        ...
        <div class="flex justify-between h-16 items-center">
            ...
            <div class="flex items-center space-x-2">
                ...
                <div class="flex-shrink-0 min-w-0">
                    <a href="{{ route('chairperson.dashboard') }}" class="flex items-center group focus:outline-none focus:ring-2 focus:ring-primary-500 rounded-md min-w-0" aria-label="Dashboard">
    ...
    <div x-show="mobileMenuOpen" 
        ...
        <div class="px-2 py-3 space-y-1">
            <x-responsive-nav-link :href="route('chairperson.dashboard')" :active="request()->routeIs('chairperson.dashboard')" class="flex items-center min-h-[44px]">
                <i class="fas fa-tachometer-alt mr-3 text-indigo-500 w-5 text-center"></i>
                {{ __('Dashboard') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('chairperson.members.index')" :active="request()->routeIs('chairperson.members.*')" class="flex items-center min-h-[44px]">
                <i class="fas fa-users mr-3 text-green-500 w-5 text-center"></i>
                {{ __('Members') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('chairperson.contributions.index')" :active="request()->routeIs('chairperson.contributions.*')" class="flex items-center min-h-[44px]">
                <i class="fas fa-hand-holding-usd mr-3 text-blue-500 w-5 text-center"></i>
                {{ __('Contributions') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('chairperson.events.index')" :active="request()->routeIs('chairperson.events.*')" class="flex items-center min-h-[44px]">
                <i class="fas fa-calendar-alt mr-3 text-purple-500 w-5 text-center"></i>
                {{ __('Events') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('chairperson.resources.index')" :active="request()->routeIs('chairperson.resources.*')" class="flex items-center min-h-[44px]">
                <i class="fas fa-book mr-3 text-yellow-500 w-5 text-center"></i>
                {{ __('Resources') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('chairperson.reports.index')" :active="request()->routeIs('chairperson.reports.*')" class="flex items-center min-h-[44px]">
                <i class="fas fa-chart-bar mr-3 text-teal-500 w-5 text-center"></i>
                {{ __('Reports') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('chairperson.notifications.index')" :active="request()->routeIs('chairperson.notifications.*')" class="flex items-center min-h-[44px]">
