...
<div class="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300">
            ...
            <div class="bg-gray-50 dark:bg-gray-800 rounded-2xl p-8 shadow-lg">
                ...
                <div class="space-y-6">
                    <div class="grid grid-cols-1 gap-4">
                        <a href="{{ route('register') }}" class="btn-primary flex items-center justify-center px-6 py-3 rounded-lg text-white font-medium transition">
                            <i class="fas fa-user-plus mr-2"></i> Create New Account
                        </a>
                        <a href="{{ route('login') }}" class="btn-secondary flex items-center justify-center px-6 py-3 rounded-lg font-medium transition">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
        ...
        <div class="mt-8">
            <a href="{{ route('register') }}" class="btn-primary inline-flex items-center justify-center px-8 py-4 text-lg font-semibold rounded-xl">
