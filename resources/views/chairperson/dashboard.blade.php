...
<div class="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-900 dark:to-slate-800 transition-colors duration-300">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <div class="relative group">
            ...
            <div class="relative bg-white dark:bg-slate-800/80 backdrop-blur-sm rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden transition-all duration-300 hover:shadow-md">
                        ...
                        <div class="flex items-center gap-5">
                            ...
                            <div>
                                <h1 class="text-3xl md:text-4xl font-semibold text-slate-800 dark:text-white">
                                    Welcome, Chairperson {{ auth()->user()->name }}
                                </h1>
                                <p class="text-slate-500 dark:text-slate-400 mt-1">This is your community management dashboard</p>
                            </div>
                        </div>
                        <div class="flex gap-3">
                            <a href="{{ route('chairperson.events.create') }}" class="inline-flex items-center px-5 py-3 btn-blue rounded-lg shadow-lg transition-all duration-300 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-blue-400">
                                <svg class="w-5 h-5 mr-2 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                                </svg>
                                Add Event
                            </a>
                            <a href="{{ route('chairperson.notifications.create') }}" class="inline-flex items-center px-5 py-3 btn-amber rounded-lg shadow-lg transition-all duration-300 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-amber-400">
                                <svg class="w-5 h-5 mr-2 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="relative bg-white/95 dark:bg-slate-800/95 rounded-xl border border-slate-200 dark:border-slate-700 shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg stat-card">
                ...
                <div class="relative p-6">
                    ...
                    <div>
                        ...
                        <p class="text-3xl font-extrabold text-slate-900 dark:text-white">{{ $stats['total_members'] }}</p>
            ...
            <div class="relative bg-white/95 dark:bg-slate-800/95 rounded-xl border border-slate-200 dark:border-slate-700 shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg stat-card">
                ...
                <div class="relative p-6">
                    ...
                    <div>
                        ...
                        <p class="text-3xl font-extrabold text-slate-900 dark:text-white">TZS {{ number_format($stats['total_contributions']) }}</p>
            ...
            <div class="relative bg-white/95 dark:bg-slate-800/95 rounded-xl border border-slate-200 dark:border-slate-700 shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg stat-card">
                ...
                <div class="relative p-6">
                    ...
                    <div>
                        ...
                        <p class="text-3xl font-extrabold text-slate-900 dark:text-white">{{ isset($stats['upcoming_events_list']) ? count($stats['upcoming_events_list']) : 0 }}</p>
        ...
        <div class="bg-white/95 dark:bg-slate-800/95 rounded-xl border border-slate-200 dark:border-slate-700 shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg">
            <div class="p-6 border-b border-slate-200 dark:border-slate-700 flex items-center justify-between section-header">
                ...
                <a href="{{ route('chairperson.events.index') }}" class="text-sm font-bold text-blue-700 dark:text-blue-300 hover:text-blue-900 dark:hover:text-white transition-colors duration-200">View All</a>
            </div>
            <div class="divide-y divide-slate-200 dark:divide-slate-700">
                ...
                <div class="p-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h4 class="font-bold text-slate-900 dark:text-white">{{ $event->name }}</h4>
                    ...
                    <div class="flex gap-2 mt-2 md:mt-0">
                        <a href="{{ route('chairperson.events.show', $event->id) }}" class="inline-flex items-center px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded shadow focus:ring-2 focus:ring-blue-400">
                            <i class="fas fa-eye mr-1"></i> View
                        </a>
                        <a href="{{ route('chairperson.events.edit', $event->id) }}" class="inline-flex items-center px-3 py-1.5 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded shadow focus:ring-2 focus:ring-indigo-400">
                            <i class="fas fa-edit mr-1"></i> Edit
                        </a>
                        <form action="{{ route('chairperson.events.destroy', $event->id) }}" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this event?');">
                            @csrf @method('DELETE')
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
            ...
            <div class="bg-white/95 dark:bg-slate-800/95 rounded-xl border border-blue-400 dark:border-blue-500 shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl stat-card">
                <div class="p-6">
                    ...
                    <x-charts.line-chart 
                        id="contributionTrends"
                        title="Monthly Contributions Trend"
                        :labels="$stats['contribution_trends']['labels']"
                        :data="$stats['contribution_trends']['data']"
                        :colors="['#6366f1', '#f59e42', '#10b981', '#ef4444']"
                        :options="['backgroundColor' => 'rgba(99,102,241,0.08)', 'borderWidth' => 4, 'pointBackgroundColor' => '#f59e42', 'pointRadius' => 6, 'tension' => 0.4]"
                    />
                </div>
            </div>
            ...
            <div class="bg-white/95 dark:bg-slate-800/95 rounded-xl border border-amber-400 dark:border-amber-500 shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl stat-card">
                <div class="p-6">
                    ...
                    <x-charts.bar-chart 
                        ...
                        :labels="$stats['event_stats']['labels']"
                        :data="$stats['event_stats']['data']"
                        :colors="['#f59e42', '#6366f1', '#10b981', '#ef4444']"
                        :options="['backgroundColor' => ['#f59e42', '#6366f1', '#10b981', '#ef4444'], 'borderRadius' => 8, 'borderWidth' => 2]"
                    />
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden transition-all duration-300 hover:shadow-md">
            <div class="p-6 border-b border-slate-200 dark:border-slate-700">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('chairperson.contributions.index') }}" class="text-sm font-medium text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors duration-200">
                        View All
                    </a>
                </div>
            </div>
            ...
            <div class="divide-y divide-slate-200 dark:divide-slate-700">
                @forelse($stats['recent_contributions'] as $contribution)
                <a href="{{ route('chairperson.contributions.show', $contribution) }}" class="block hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors duration-200">
                    <div class="p-6">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-4">
                                <div class="relative">
                                ...
                                <div>
                                    <h4 class="font-medium text-slate-800 dark:text-white">{{ $contribution->member->user->name }}</h4>
                            ...
                            <div class="text-right">
                                ...
                                <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium {{ $contribution->status === 'confirmed' ? 'bg-emerald-100 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-200' : 'bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-200' }}">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden transition-all duration-300 hover:shadow-md">
            <div class="p-6 border-b border-slate-200 dark:border-slate-700">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('chairperson.activities.index') }}" class="text-sm font-medium text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 transition-colors duration-200">
                        View All
                    </a>
                </div>
            </div>
            <div class="divide-y divide-slate-200 dark:divide-slate-700">
                ...
                <div class="p-6 flex items-center gap-4">
                    <div class="w-12 h-12 rounded-lg flex items-center justify-center bg-gradient-to-br from-indigo-100 to-blue-100 dark:from-indigo-900/30 dark:to-blue-900/30">
                        <i class="fas fa-@php echo $activity->getActivityIcon(); @endphp text-{{ $activity->getActionColor() }}-600 dark:text-{{ $activity->getActionColor() }}-400 text-2xl"></i>
                    </div>
                    <div class="flex-1">
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                            <div>
                                <span class="font-bold text-slate-800 dark:text-white">{{ $activity->user->name ?? 'System' }}</span>
                                <span class="mx-2 text-xs font-semibold px-2 py-0.5 rounded bg-{{ $activity->getActionColor() }}-100 text-{{ $activity->getActionColor() }}-800 dark:bg-{{ $activity->getActionColor() }}-900/30 dark:text-{{ $activity->getActionColor() }}-200">
