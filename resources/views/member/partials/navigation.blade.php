...
<body x-data="{ mobileMenuOpen: false, notificationsOpen: false, darkMode: false }" :class="{ 'dark': darkMode }" class="font-sans antialiased bg-gray-50">
    <nav class="bg-white border-b border-gray-100 shadow-lg" aria-label="Main navigation">
            ...
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden sm:ml-10 sm:flex sm:space-x-8">
                        ...
                        <x-nav-link :href="route('member.contributions.index')" 
                                   :active="request()->routeIs('member.contributions.*')"
                                   aria-label="Contributions">
                            <i class="fas fa-hand-holding-usd mr-2 text-green-500"></i>
                            {{ __('Contributions') }}
                        </x-nav-link>
                        <x-nav-link :href="route('member.events.index')" 
                                   :active="request()->routeIs('member.events.*')"
                                   aria-label="Events">
                            <i class="fas fa-calendar-alt mr-2 text-purple-500"></i>
                            {{ __('Events') }}
                        </x-nav-link>
                        <x-nav-link :href="route('member.resources.index')" 
                                   :active="request()->routeIs('member.resources.*')"
...
<script>
    document.addEventListener('alpine:init', () => {
        Alpine.data('darkMode', () => ({
            darkMode: false, // default mode is light
            init() {
                // Check for dark mode preference in local storage or use system default
