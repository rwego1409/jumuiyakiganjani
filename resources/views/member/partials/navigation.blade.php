        ...
        <div class="flex justify-between h-16 items-center">
            ...
            <div class="flex items-center space-x-2">
                ...
                <div class="flex-shrink-0 min-w-0">
                    <a href="{{ route('member.dashboard') }}" class="flex items-center group focus:outline-none focus:ring-2 focus:ring-primary-500 rounded-md min-w-0" aria-label="Dashboard">
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-4 space-x-2">
                    ...
                    @if(Route::has('member.events.index'))
                    ...
                    @endif
                    @if(Route::has('member.resources.index'))
