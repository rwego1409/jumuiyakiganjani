...
@section('content')
<div class="py-12 bg-gradient-to-br from-blue-50 via-white to-blue-100 dark:from-blue-900 dark:via-gray-800 dark:to-blue-900 min-h-screen">
...
<h2 class="text-3xl font-bold text-blue-700 dark:text-blue-200">Notifications</h2>
                        </div>
