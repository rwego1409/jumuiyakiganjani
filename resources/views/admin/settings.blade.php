                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="app_name" value="{{ setting('app_name') }}" class="mt-1 block w-full rounded-md dark:bg-gray-700 dark:text-white border-gray-300">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">App URL</label>
                                <input type="url" name="app_url" value="{{ setting('app_url') }}" class="mt-1 block w-full rounded-md dark:bg-gray-700 dark:text-white border-gray-300">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="email" name="support_email" value="{{ setting('support_email') }}" class="mt-1 block w-full rounded-md dark:bg-gray-700 dark:text-white border-gray-300">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Phone Number</label>
                                <input type="text" name="phone" value="{{ setting('phone') }}" class="mt-1 block w-full rounded-md dark:bg-gray-700 dark:text-white border-gray-300">
                            </div>
                        </div>
                    </div>
