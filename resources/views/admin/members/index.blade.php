            ...
            <div class="p-6">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
                    <div class="flex items-center mb-4 sm:mb-0">
                        ...
                        <h2 class="text-2xl font-semibold text-gray-900 dark:text-gray-100">Members Management</h2>
                    </div>
                ...
                <div class="overflow-x-auto">
                    <table id="members-table" class="stripe hover display nowrap w-full text-sm text-left">
                        <thead class="bg-gray-50 dark:bg-gray-700 text-gray-700 dark:text-gray-300 uppercase">
                            <tr>
                                <th class="px-6 py-3">Member Info</th>
                                <th class="px-6 py-3">Jumuiya</th>
...
@endif
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex space-x-4">
                                        <a href="{{ route('admin.members.edit', $member->id) }}" class="text-primary-600 hover:text-primary-900 dark:text-primary-400 dark:hover:text-primary-300 flex items-center">
