            ...
            <div class="p-6">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
                    <div class="flex items-center mb-4 sm:mb-0">
                        ...
                        <h2 class="text-2xl font-semibold text-gray-900">Members Management</h2>
                    </div>
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-10 w-10">
                                            <img class="h-10 w-10 rounded-full object-cover" src="{{ $member->user->profile_photo_url }}" alt="{{ $member->user->name }}">
                                        </div>
