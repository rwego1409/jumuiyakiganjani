...
@section('content')
<div class="py-8 bg-gradient-to-br from-primary-50 via-white to-primary-100 dark:from-primary-900 dark:via-gray-800 dark:to-primary-900 min-h-screen">
            ...
            <div class="p-6">
                ...
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
                    <div class="flex items-center mb-6 sm:mb-0">
                        <a href="{{ route('admin.dashboard') }}" class="inline-flex items-center px-4 py-2 btn-indigo rounded-lg shadow transition-all duration-200 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-indigo-400 mr-4">
                            <svg class="w-5 h-5 mr-2 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                            </svg>
                            Back to Dashboard
                        </a>
                        <svg class="h-8 w-8 text-primary-500 dark:text-primary-400 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                        </svg>
                        <h2 class="text-2xl font-bold text-primary-900 dark:text-primary-100">Activities</h2>
                    </div>
