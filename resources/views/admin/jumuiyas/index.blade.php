...
@section('content')
<div class="py-12 bg-gradient-to-br from-orange-50 via-white to-orange-100 dark:from-orange-900 dark:via-gray-800 dark:to-orange-900 min-h-screen">
            ...
            <div class="p-6">
                ...
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
                    <div class="flex items-center mb-6 sm:mb-0">
                        ...
                        <h2 class="text-3xl font-bold text-orange-900 dark:text-orange-100">Jumuiyas Management</h2>
                    </div>
