...
<nav x-data="{ 
        ...
        <div class="flex justify-between h-16 items-center">
            ...
            <div class="flex items-center space-x-2">
                ...
                <div class="flex-shrink-0 min-w-0">
                    <a href="{{ route('admin.dashboard') }}" class="flex items-center group focus:outline-none focus:ring-2 focus:ring-primary-500 rounded-md min-w-0" aria-label="Dashboard">
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-4 space-x-2">
                    ...
                    <x-nav-link :href="route('admin.chairpersons.index')" :active="request()->routeIs('admin.chairpersons.*')">
                        ...
                        <span class="hidden md:inline">{{ __('Chairpersons') }}</span>
    ...
    <div x-show="mobileMenuOpen" 
        ...
        <div class="px-2 py-3 space-y-1">
            <x-responsive-nav-link :href="route('admin.dashboard')" :active="request()->routeIs('admin.dashboard')" class="flex items-center min-h-[44px]">
                <i class="fas fa-tachometer-alt mr-3 text-primary-500 w-5 text-center"></i>
                {{ __('Dashboard') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin.jumuiyas.index')" :active="request()->routeIs('admin.jumuiyas.*')" class="flex items-center min-h-[44px]">
                <i class="fas fa-users-cog mr-3 text-orange-500 w-5 text-center"></i>
                {{ __('Jumuiyas') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin.chairpersons.index')" :active="request()->routeIs('admin.chairpersons.*')" class="flex items-center min-h-[44px]">
                <i class="fas fa-user-tie mr-3 text-pink-500 w-5 text-center"></i>
                {{ __('Chairpersons') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin.members.index')" :active="request()->routeIs('admin.members.*')" class="flex items-center min-h-[44px]">
                <i class="fas fa-users mr-3 text-blue-500 w-5 text-center"></i>
                {{ __('Members') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin.contributions.index')" :active="request()->routeIs('admin.contributions.*')" class="flex items-center min-h-[44px]">
                <i class="fas fa-hand-holding-usd mr-3 text-green-500 w-5 text-center"></i>
                {{ __('Contributions') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin.events.index')" :active="request()->routeIs('admin.events.*')" class="flex items-center min-h-[44px]">
                <i class="fas fa-calendar-alt mr-3 text-purple-500 w-5 text-center"></i>
                {{ __('Events') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin.resources.index')" :active="request()->routeIs('admin.resources.*')" class="flex items-center min-h-[44px]">
                <i class="fas fa-file-alt mr-3 text-yellow-500 w-5 text-center"></i>
                {{ __('Resources') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin.notifications.index')" :active="request()->routeIs('admin.notifications.*')" class="flex items-center min-h-[44px]">
        ...
        <div class="px-4 py-3 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-750">
            ...
            <div class="mt-3 space-y-1">
                ...
                <x-responsive-nav-link :href="route('admin.settings')" class="flex items-center min-h-[44px]">
