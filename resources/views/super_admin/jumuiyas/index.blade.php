                ...
                @forelse($jumuiyas as $jumuiya)
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-gray-900 dark:text-white">{{ $jumuiya->name }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900 dark:text-white">{{ $jumuiya->location ?? '-' }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900 dark:text-white">{{ $jumuiya->chairperson->name ?? '-' }}</div>
                            @if($jumuiya->chairperson)
                                <div class="text-sm text-gray-500 dark:text-gray-400">{{ $jumuiya->chairperson->email }}</div>
                            @endif
                        </td>
