        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center">
                ...
                <div class="flex-shrink-0">
                    <a href="{{ route('super_admin.dashboard') }}" class="flex items-center group focus:outline-none focus:ring-2 focus:ring-primary-500 rounded-md" aria-label="Dashboard">
                ...
                <div class="hidden sm:ml-6 sm:flex sm:space-x-4 lg:space-x-8">
                    ...
                    <x-nav-link :href="route('super_admin.jumuiyas.index')" :active="request()->routeIs('super_admin.jumuiyas.*')" aria-label="Jumuiyas">
                        ...
                        <span class="hidden md:inline">{{ __('Jumuiyas') }}</span>
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('super_admin.notifications.index')" :active="request()->routeIs('super_admin.notifications.*')" aria-label="Notifications">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6 space-x-4">
                ...
                <button @click="darkMode = !darkMode; localStorage.theme = darkMode ? 'dark' : 'light'; document.documentElement.classList.toggle('dark', darkMode)"
                        class="p-2 text-gray-500 hover:text-primary-500 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-full dark:text-gray-400 dark:hover:text-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500 transition-colors"
