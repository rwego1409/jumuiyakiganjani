...
@section('content')
    <div class="container mx-auto mt-10">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route($routePrefix . 'create') }}" class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition duration-300">
            ...
            <div class="space-y-4">
                @foreach ($notifications as $notification)
                    <div class="flex justify-between items-center p-4 bg-white rounded-lg shadow-md border border-gray-200">
                        ...
                        <a href="{{ route($routePrefix . 'show', $notification->id) }}" class="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition duration-200">View</a>
                    </div>
                @endforeach
            </div>
            <div class="mt-6">
        ...
        @else
            <div class="p-4 text-center bg-yellow-100 text-yellow-800 rounded-lg">
                No notifications found. <a href="{{ route($routePrefix . 'create') }}" class="text-blue-600 hover:text-blue-700">Create one now</a>.
            </div>
        @endif
    </div>
@endsection
