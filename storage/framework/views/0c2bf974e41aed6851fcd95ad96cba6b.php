...
<?php endif; ?>
                ...
                <div class="overflow-x-auto bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700" x-data="{
                    ...
                    <table id="contributions-table" class="stripe hover display nowrap w-full text-sm text-left">
                        ...
                        <tbody x-ref="tbody" class="divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr x-show="filtered.includes($el)" data-member="<?php echo e(strtolower($contribution->member->user->name ?? '')); ?>" data-purpose="<?php echo e(strtolower($contribution->purpose ?? '')); ?>">
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex space-x-4">
                                        ...
                                        <!-- <a href="<?php echo e(route('admin.contributions.scheduleReminder', $contribution)); ?>" class="text-yellow-600 hover:text-yellow-900 dark:text-yellow-400 dark:hover:text-yellow-300 flex items-center transition duration-200">
                                            <svg class="h-4 w-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <?php if(method_exists($contributions, 'links') && $contributions->hasPages()): ?>
                <div class="mt-6">
