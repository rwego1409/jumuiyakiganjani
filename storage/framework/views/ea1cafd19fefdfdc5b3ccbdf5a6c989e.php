            ...
            <div class="p-4 sm:p-6">
                ...
                <div id="cardView">
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-8 text-center">
                        ...
                        <div class="mt-6">
                            <a href="<?php echo e(route('admin.resources.create')); ?>" class="btn-jumuiya inline-flex items-center px-4 py-2 text-sm font-medium rounded-md shadow-sm text-white bg-primary-600 hover:bg-primary-700 focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 dark:bg-primary-500 dark:hover:bg-primary-600">
                                Upload Resource
                            </a>
                        </div>
                    </div>
                    ...
                    <div id="cardContainer" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="resource-card bg-white/70 dark:bg-gray-800/70 backdrop-blur-md rounded-2xl shadow-xl border border-yellow-100 dark:border-yellow-900 hover:shadow-2xl hover:scale-105 transition-all duration-200 ease-out relative overflow-hidden">
                            ...
                            <div class="relative p-6">
                                ...
                                <div class="flex items-center justify-between mb-3">
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-xs font-medium text-yellow-700 dark:text-yellow-300 bg-yellow-100 dark:bg-yellow-700/40 px-2 py-1 rounded">
                                            <?php echo e(strtoupper($resource->type)); ?>
                                ...
                                <!-- Card Content -->
                                <h3 class="text-lg font-bold text-gray-900 dark:text-gray-100 mb-2"><?php echo e($resource->title); ?></h3>
                                ...
                                <div class="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-yellow-900/30">
                                    ...
                                    <div class="space-x-2">
                                        <a href="<?php echo e(route('admin.resources.edit', $resource->id)); ?>" class="text-yellow-700 hover:text-yellow-900 dark:text-yellow-300 dark:hover:text-yellow-100 font-semibold">Edit</a>
                                        <form action="<?php echo e(route('admin.resources.destroy', $resource->id)); ?>" method="POST" class="inline-block" onsubmit="return confirm('Delete this resource?')">
                        ...
                        <table id="resourcesTable" class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-gray-100 font-medium"><?php echo e($resource->title); ?></td>
                                    <td class="px-6 py-4 text-gray-500 dark:text-gray-300"><?php echo e(Str::limit($resource->description, 50)); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-gray-500 dark:text-gray-400"><?php echo e($resource->created_at->format('M d, Y')); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex space-x-4">
                                            ...
                                            <form action="<?php echo e(route('admin.resources.destroy', $resource->id)); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jumuiyakiganjani\resources\views/admin/resources/index.blade.php ENDPATH**/ ?>