    ...
    <div class="max-w-6xl mx-auto px-2 sm:px-4 lg:px-8">
        <div class="bg-white/80 dark:bg-purple-900/80 backdrop-blur-md shadow-2xl rounded-2xl border border-pink-200/60 dark:border-purple-700/60 p-4 sm:p-8">
            <div class="mb-6 flex flex-col sm:flex-row items-center gap-2 sm:gap-3 justify-between">
                <h2 class="text-xl sm:text-2xl font-bold bg-gradient-to-r from-pink-600 to-purple-600 bg-clip-text text-transparent drop-shadow-lg text-center sm:text-left w-full"><?php echo e(__('Contributions')); ?></h2>
                <a href="<?php echo e(route('chairperson.contributions.create')); ?>" class="mt-2 sm:mt-0 inline-flex items-center px-4 py-2 bg-blue-100 text-blue-700 border border-blue-200 rounded-xl font-semibold text-xs sm:text-sm uppercase tracking-widest shadow hover:bg-blue-200 hover:text-blue-900 focus:outline-none focus:ring-2 focus:ring-blue-400 transition">
                    <i class="fas fa-plus mr-2 text-blue-500"></i> <?php echo e(__('Add Contribution')); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div class="bg-white/80 dark:bg-gray-700/80 backdrop-blur-md rounded-2xl shadow-2xl border border-purple-200/50 dark:border-purple-900/50 p-6">
                    ...
                    <div class="text-2xl font-bold text-gray-900 dark:text-white">TZS <?php echo e(number_format($stats['total_amount'])); ?></div>
                </div>
                <div class="bg-white/80 dark:bg-gray-700/80 backdrop-blur-md rounded-2xl shadow-2xl border border-purple-200/50 dark:border-purple-900/50 p-6">
                    <div class="text-xs md:text-sm font-medium text-purple-700 dark:text-purple-300">Total Contributions</div>
                    <div class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($stats['total_contributions']); ?></div>
                </div>
                <div class="bg-white/80 dark:bg-gray-700/80 backdrop-blur-md rounded-2xl shadow-2xl border border-purple-200/50 dark:border-purple-900/50 p-6">
                    <div class="text-xs md:text-sm font-medium text-purple-700 dark:text-purple-300">Pending Contributions</div>
                    <div class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($stats['pending_contributions']); ?></div>
                </div>
            </div>
                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = $contributions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contribution): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <tr>
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                        <a href="<?php echo e(route('chairperson.contributions.show', $contribution)); ?>" class="text-indigo-600 hover:text-indigo-900 mr-3">
                                                            <i class="fas fa-eye text-blue-500"></i>
                                                        </a>
                                                        <a href="<?php echo e(route('chairperson.contributions.edit', $contribution)); ?>" class="bg-blue-100 text-blue-700 hover:bg-blue-200 hover:text-blue-900 px-3 py-1 rounded font-semibold shadow focus:outline-none focus:ring-2 focus:ring-blue-400 transition mr-2">
                                                            <i class="fas fa-edit text-blue-500"></i>
                                                        </a>
                                                        <form action="<?php echo e(route('chairperson.contributions.destroy', $contribution)); ?>" method="POST" class="inline-block">
                                                            <?php echo csrf_field(); ?>
