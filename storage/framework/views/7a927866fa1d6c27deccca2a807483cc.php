...
<div class="max-w-7xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-8">
    <div class="flex flex-col md:flex-row md:justify-between md:items-center mb-4 md:mb-6 gap-2 md:gap-0">
        ...
        <?php if(auth()->user()->isChairperson()): ?>
            <a href="<?php echo e(route('chairperson.notifications.create')); ?>" class="inline-flex items-center px-4 py-2 bg-primary-600 text-white rounded hover:bg-primary-700 transition-colors w-full md:w-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-6 mb-4 md:mb-8">
        ...
        <div class="bg-blue-600 dark:bg-blue-700 shadow-lg rounded-lg p-4 md:p-6 flex flex-col items-center border border-blue-400/40 dark:border-blue-800/40">
            ...
            <div class="text-2xl md:text-3xl font-extrabold text-white drop-shadow-lg"><?php echo e($totalJumuiyas); ?></div>
        ...
        <div class="bg-yellow-500 dark:bg-yellow-600 shadow-lg rounded-lg p-4 md:p-6 flex flex-col items-center border border-yellow-400/40 dark:border-yellow-800/40">
            ...
            <div class="text-2xl md:text-3xl font-extrabold text-white drop-shadow-lg"><?php echo e($totalChairpersons); ?></div>
        ...
        <div class="bg-red-500 dark:bg-red-600 shadow-lg rounded-lg p-4 md:p-6 flex flex-col items-center border border-red-300/40 dark:border-red-700/40">
            ...
            <div class="text-2xl md:text-3xl font-extrabold text-white drop-shadow-lg"><?php echo e($totalAdmins); ?></div>
        ...
        <div class="bg-purple-600 dark:bg-purple-700 shadow-lg rounded-lg p-4 md:p-6 flex flex-col items-center border border-purple-400/40 dark:border-purple-800/40">
            ...
            <div class="text-2xl md:text-3xl font-extrabold text-white drop-shadow-lg"><?php echo e($totalMembers); ?></div>
        ...
        <ul class="text-xs md:text-base">
            <?php $__empty_1 = true; $__currentLoopData = $recentJumuiyas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jumuiya): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <li class="mb-2 flex items-center gap-2">
                    ...
                    <span class="font-semibold text-pink-700 dark:text-pink-200"><?php echo e($jumuiya->name); ?></span>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $recentActivities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <li class="py-3 flex flex-col sm:flex-row sm:items-center gap-4">
                    <div class="w-10 h-10 rounded-lg flex items-center justify-center bg-gradient-to-br from-pink-200 via-yellow-200 to-purple-200 dark:from-pink-800 dark:via-yellow-800 dark:to-purple-800">
                        <i class="fas fa-<?php echo e($activity->getActivityIcon()); ?> text-pink-500 dark:text-pink-300 text-lg"></i>
                    </div>
                    <div class="flex-1 min-w-0">
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-1">
                            <div class="truncate">
                                <span class="font-bold text-pink-800 dark:text-pink-100"><?php echo e($activity->user->name ?? 'System'); ?></span>
                                ...
                                <span class="text-pink-700 dark:text-pink-200 truncate block md:inline"><?php echo e($activity->description); ?></span>
                            </div>
...
<script>
    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Count',
                data: <?php echo json_encode([$totalJumuiyas, $totalChairpersons, $totalMembers]); ?>,
                backgroundColor: [
                    'rgba(59, 130, 246, 0.7)',
                    'rgba(236, 72, 153, 0.7)',
                    'rgba(34, 197, 94, 0.7)'
