                    ...
                    <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3">
                        <div class="flex items-center space-x-2 px-4 py-2 bg-blue-100 dark:bg-blue-900/30 rounded-full">
                            ...
                            <span class="text-sm font-medium text-blue-700 dark:text-blue-300" id="total-count">
                                <?php echo e($jumuiyas->count()); ?> Records
                            </span>
                        </div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 flex-1">
                        ...
                        <div class="relative">
                            <select id="location-filter" 
                                ...
                                <?php $__currentLoopData = $jumuiyas->pluck('location')->unique()->filter(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tbody id="table-body" class="divide-y divide-gray-200/30 dark:divide-gray-700/30">
                        <?php $__empty_1 = true; $__currentLoopData = $jumuiyas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jumuiya): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="group hover:bg-gradient-to-r hover:from-blue-50/50 hover:to-indigo-50/50 dark:hover:from-gray-700/20 dark:hover:to-gray-600/20 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/10" 
                                data-name="<?php echo e(strtolower($jumuiya->name)); ?>"
                                data-location="<?php echo e(strtolower($jumuiya->location ?? '')); ?>"
                                data-chairperson="<?php echo e(strtolower($jumuiya->chairperson->name ?? '')); ?>"
                                data-members="<?php echo e($jumuiya->members->count()); ?>">
                                <td class="px-6 py-5">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-xl flex items-center justify-center mr-4 group-hover:scale-110 transition-transform duration-300">
                                            <span class="text-white font-bold text-sm">
                                                <?php echo e(strtoupper(substr($jumuiya->name, 0, 2))); ?>
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <div class="text-sm text-gray-600 dark:text-gray-400 group-hover:text-gray-800 dark:group-hover:text-gray-200 transition-colors duration-300">
                                                <?php echo e($jumuiya->location ?: 'Not specified'); ?>
                                    ...
                                    <div class="flex items-center">
                                        <div class="w-8 h-8 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center mr-3 group-hover:scale-110 transition-transform duration-300">
                                            <span class="text-white font-bold text-xs">
                                                <?php echo e(strtoupper(substr($jumuiya->chairperson->name ?? 'N', 0, 1))); ?>

                                            </span>
                                        </div>
                                        <div>
                                            <div class="text-sm text-gray-600 dark:text-gray-400 group-hover:text-gray-800 dark:group-hover:text-gray-200 transition-colors duration-300">
                                                <?php echo e($jumuiya->chairperson->name ?? 'Not assigned'); ?>
                                ...
                                <td class="px-6 py-5">
                                    <div class="flex items-center">
                                        ...
                                        ?>
                                        <div class="px-3 py-1 bg-gradient-to-r <?php echo e($badgeColor); ?> rounded-full border">
                                        ...
                                        <div class="ml-2 text-xs text-gray-500 dark:text-gray-400">
                                            <?php echo e($memberCount === 1 ? 'member' : 'members'); ?>
                                ...
                                <td class="px-6 py-5">
                                    <div class="flex items-center space-x-2">
                                        <a href="<?php echo e(route('admin.jumuiyas.show', $jumuiya)); ?>" 
                                        ...
                                        <a href="<?php echo e(route('admin.jumuiyas.edit', $jumuiya)); ?>" 
                                        ...
                                        <?php if($jumuiya->members->count() === 0): ?>
                                            <form action="<?php echo e(route('admin.jumuiyas.destroy', $jumuiya)); ?>" 
                                                  method="POST" 
                                                  class="inline-block">
                                                <?php echo csrf_field(); ?>
            ...
            <div class="px-6 py-4 bg-gradient-to-r from-gray-50/50 to-blue-50/50 dark:from-gray-800/50 dark:to-gray-700/50 border-t border-gray-200/50 dark:border-gray-600/50">
                <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                    <div class="flex items-center space-x-4 text-sm text-gray-600 dark:text-gray-400">
                        <span>Showing <span id="showing-start">1</span> to <span id="showing-end"><?php echo e(min(25, $jumuiyas->count())); ?></span> of <span id="total-records"><?php echo e($jumuiyas->count()); ?></span> results</span>
                    </div>
                    
                    <?php if($jumuiyas instanceof \Illuminate\Pagination\LengthAwarePaginator && $jumuiyas->hasPages()): ?>
