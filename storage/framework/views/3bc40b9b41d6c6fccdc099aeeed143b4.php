...
<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
    <div class="p-6 text-gray-900">
        <div class="mb-6">
            <h2 class="text-2xl font-semibold"><?php echo e(__('Record New Contribution')); ?></h2>
        </div>

        <form action="<?php echo e(route('chairperson.contributions.store')); ?>" method="POST" class="max-w-2xl">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" name="amount" id="amount" min="1" step="1" value="<?php echo e(old('amount')); ?>" required
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="date" name="contribution_date" id="contribution_date" value="<?php echo e(old('contribution_date', date('Y-m-d'))); ?>" required
                        class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <select id="payment_method" name="payment_method" required
                        ...
                        <option value="mobile" <?php echo e(old('payment_method') == 'mobile' ? 'selected' : ''); ?>>Mobile Money</option>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="purpose" id="purpose" value="<?php echo e(old('purpose')); ?>"
                        class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex items-center justify-end">
                    ...
                    <button type="submit" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700">
                        <?php echo e(__('Record Contribution')); ?>
...
<?php echo $__env->make('layouts.chairperson', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jumuiyakiganjani\resources\views/chairperson/contributions/create.blade.php ENDPATH**/ ?>