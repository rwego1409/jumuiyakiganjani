<!DOCTYPE html>
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" x-data="darkMode" x-init="init()" :class="{ 'dark': darkMode }" class="h-full">
<head>
    <meta charset="utf-8">
        ...
        <div class="fixed w-full z-30 top-0 left-0">
            <?php if(auth()->guard()->check()): ?>
                ...
                <?php elseif($role === 'member'): ?>
                    <?php echo $__env->make('member.partials.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <?php elseif($role === 'super_admin'): ?>
                    <?php echo $__env->make('super_admin.partials.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php endif; ?>
            <?php endif; ?>
        </div>
