...
<body class="font-sans antialiased bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-300">
    ...
    <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex justify-between items-center">
        ...
        <div class="flex items-center space-x-4">
            <a href="<?php echo e(route('login')); ?>" class="px-4 py-2 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition">
                Login
            </a>
            <a href="<?php echo e(route('register')); ?>" class="px-4 py-2 rounded-lg text-white bg-indigo-600 hover:bg-indigo-700 dark:bg-indigo-500 dark:hover:bg-indigo-600 transition">
                Register
            </a>
        </div>
    </nav>
        ...
        <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="mt-4 space-y-4">
                        <li>
                            <a href="<?php echo e(route('login')); ?>" class="footer-link text-base text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">
                                Login
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('register')); ?>" class="footer-link text-base text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">
                                Register
                            </a>
                        </li>
                    </ul>
...
</html><?php /**PATH C:\xampp\htdocs\jumuiyakiganjani\resources\views/layouts/landing.blade.php ENDPATH**/ ?>