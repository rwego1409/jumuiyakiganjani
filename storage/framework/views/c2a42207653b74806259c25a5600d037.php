    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="mb-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <a href="<?php echo e(route('admin.chairpersons.create')); ?>" 
        ...
        <div class="mb-8">
            <form action="<?php echo e(route('admin.chairpersons.assign')); ?>" method="POST" class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 flex flex-col sm:flex-row items-center gap-4">
                <?php echo csrf_field(); ?>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden" x-data="{
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody x-ref="tbody">
                        <?php $__empty_1 = true; $__currentLoopData = $chairpersons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chairperson): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr x-show="filtered.includes($el)" data-name="<?php echo e(strtolower($chairperson->name ?? '')); ?>" data-email="<?php echo e(strtolower($chairperson->email ?? '')); ?>" data-phone="<?php echo e(strtolower($chairperson->phone ?? '')); ?>" class="hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors duration-150">
                                        ...
                                        <div class="flex-shrink-0 h-10 w-10">
                                            <div class="h-10 w-10 rounded-full bg-gradient-to-r from-pink-500 to-rose-500 flex items-center justify-center shadow-lg border-2 border-pink-300">
                                                <span class="text-sm font-bold text-white uppercase drop-shadow-sm">
                                                    <?php echo e($chairperson->name ? strtoupper(substr(trim($chairperson->name), 0, 2)) : 'NA'); ?>

                                                </span>
                                            </div>
                                        </div>
                                        <div class="ml-4">
                                            <div class="text-sm font-semibold text-gray-900 dark:text-white"><?php echo e($chairperson->name ?? 'N/A'); ?></div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-sm text-gray-900 dark:text-white"><?php echo e($chairperson->email ?? 'N/A'); ?></span>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-sm text-gray-900 dark:text-white"><?php echo e($chairperson->phone ?? 'N/A'); ?></span>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center space-x-2">
                                        <a href="<?php echo e(route('admin.chairpersons.show', $chairperson)); ?>" class="inline-flex items-center px-3 py-1.5 text-xs font-medium text-blue-700 hover:text-blue-900 bg-blue-100 hover:bg-blue-200 rounded-md transition-colors duration-150" title="View Details">
                                        ...
                                        <a href="<?php echo e(route('admin.chairpersons.edit', $chairperson)); ?>" class="inline-flex items-center px-3 py-1.5 text-xs font-medium text-amber-700 hover:text-amber-900 bg-amber-100 hover:bg-amber-200 rounded-md transition-colors duration-150" title="Edit Chairperson">
                                            <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                            </svg>
                                            Edit
                                        </a>
                                        <form action="<?php echo e(route('admin.chairpersons.destroy', $chairperson)); ?>" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this chairperson? This action cannot be undone.')">
                                            <?php echo csrf_field(); ?>
                            ...
                            <tr>
                                <td colspan="4" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <a href="<?php echo e(route('admin.chairpersons.create')); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors duration-200">
                                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                                            </svg>
        ...
        <!-- Pagination -->
        <?php if(method_exists($chairpersons, 'hasPages') && $chairpersons->hasPages()): ?>
            <div class="mt-6 flex items-center justify-between">
                <!-- Mobile pagination -->
                <div class="flex-1 flex justify-between sm:hidden">
                    <?php if($chairpersons->onFirstPage()): ?>
                        <span class="relative inline-flex items-center px-4 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 cursor-default leading-5 rounded-md">
                            « Previous
                        </span>
                    <?php else: ?>
                        <a href="<?php echo e($chairpersons->previousPageUrl()); ?>" class="relative inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 leading-5 rounded-md hover:text-gray-500 focus:outline-none focus:ring ring-gray-300 focus:border-blue-300 active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150">
                            « Previous
                        </a>
                    <?php endif; ?>

                    <?php if($chairpersons->hasMorePages()): ?>
                        <a href="<?php echo e($chairpersons->nextPageUrl()); ?>" class="relative inline-flex items-center px-4 py-2 ml-3 text-sm font-medium text-gray-700 bg-white border border-gray-300 leading-5 rounded-md hover:text-gray-500 focus:outline-none focus:ring ring-gray-300 focus:border-blue-300 active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150">
                            Next »
                        </a>
                    <?php else: ?>
                ...
                <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                    <div>
                        <p class="text-sm text-gray-700 dark:text-gray-300">
                            Showing <span class="font-medium"><?php echo e($chairpersons->firstItem()); ?></span> to <span class="font-medium"><?php echo e($chairpersons->lastItem()); ?></span> of <span class="font-medium"><?php echo e($chairpersons->total()); ?></span> results
                        </p>
                    </div>
                    <div>
                        <?php echo e($chairpersons->links()); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jumuiyakiganjani\resources\views/admin/chairpersons/index.blade.php ENDPATH**/ ?>