...
<div class="min-h-screen bg-gradient-to-br from-pink-50 via-white to-purple-100 dark:from-pink-900 dark:via-gray-800 dark:to-purple-900">
                                ...
                                <tr class="group hover:bg-gradient-to-r hover:from-pink-50/70 hover:to-purple-50/70 dark:hover:from-pink-900/20 dark:hover:to-purple-900/20 transition-all duration-200 ease-out">
                                    <td class="px-6 py-6">
                                        <div class="relative">
                                            <div class="w-14 h-14 rounded-2xl bg-gradient-to-br from-pink-500 to-purple-600 text-white flex items-center justify-center font-bold text-xl shadow-xl group-hover:shadow-2xl group-hover:scale-110 backdrop-blur-md bg-opacity-80 transition-all duration-200 border-4 border-white dark:border-gray-900">
                                                <?php echo e(Str::substr($chairperson->name, 0, 1)); ?>
                                    ...
                                    <td class="px-6 py-6">
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <span class="text-gray-700 dark:text-gray-300 font-medium"><?php echo e($chairperson->email); ?></span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-6">
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <span class="text-gray-700 dark:text-gray-300 font-medium"><?php echo e($chairperson->phone); ?></span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-6">
                                        <div class="flex items-center space-x-3">
                                            <a href="<?php echo e(route('admin.chairpersons.show', $chairperson)); ?>"
                                            ...
                                            <a href="<?php echo e(route('admin.chairpersons.edit', $chairperson)); ?>"
                                            ...
                                            <form action="<?php echo e(route('admin.chairpersons.destroy', $chairperson)); ?>" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this chairperson?')">
                                                <?php echo csrf_field(); ?>
