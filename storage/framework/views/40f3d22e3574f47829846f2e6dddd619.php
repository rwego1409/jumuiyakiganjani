            ...
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="bg-gray-50 p-6 rounded-lg">
                        ...
                        <dl class="space-y-4">
                            <div>
                                ...
                                <dd class="mt-1 text-gray-900"><?php echo e($resource->title); ?></dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-gray-500">Type</dt>
                                <dd class="mt-1 text-gray-900 capitalize"><?php echo e($resource->type); ?></dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-gray-500">Upload Date</dt>
                                <dd class="mt-1 text-gray-900"><?php echo e($resource->created_at->format('M d, Y H:i')); ?></dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-gray-500">Downloads</dt>
                                <dd class="mt-1 text-gray-900"><?php echo e($resource->download_count ?? 0); ?></dd>
                            </div>
                        </dl>
                    </div>
                    ...
                    <div class="bg-gray-50 p-6 rounded-lg">
                        ...
                        <dl class="space-y-4">
                            <div>
                                ...
                                <dd class="mt-1 text-gray-900"><?php echo e($resource->original_filename); ?></dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-gray-500">File Type</dt>
                                <dd class="mt-1 text-gray-900 uppercase"><?php echo e($resource->file_extension); ?></dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-gray-500">File Size</dt>
                                <dd class="mt-1 text-gray-900"><?php echo e($resource->file_size); ?> KB</dd>
                            </div>
                            <div>
                                <a href="<?php echo e(route('admin.resources.download', $resource)); ?>" 
                    ...
                    <div class="md:col-span-2 bg-gray-50 p-6 rounded-lg">
                        ...
                        <p class="text-gray-700 whitespace-pre-line"><?php echo e($resource->description); ?></p>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jumuiyakiganjani\resources\views/admin/resources/show.blade.php ENDPATH**/ ?>