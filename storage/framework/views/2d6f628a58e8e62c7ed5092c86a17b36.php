...
<?php endif; ?>
        ...
        <!-- Extra Links -->
        <div class="mt-6 flex flex-col sm:flex-row sm:justify-between items-center text-sm text-gray-600">
            ...
            <a href="<?php echo e(url('/')); ?>" class="mt-2 sm:mt-0 text-indigo-600 hover:underline">← Back to Homepage</a>
        </div>
     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\jumuiyakiganjani\resources\views/auth/login.blade.php ENDPATH**/ ?>