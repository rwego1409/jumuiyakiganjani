            ...
            <div class="p-6">
                <div class="flex flex-wrap justify-between items-center gap-y-4">
                    ...
                    <div class="flex items-center text-sm text-gray-500">
                        ...
                        Last Updated: <?php echo e(now()->format('F j, Y, g:i a')); ?>
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900"><?php echo e($totalMembers ?? 0); ?></p>
                            <div class="flex items-center text-sm text-green-600 mt-1">
                                <svg class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                                </svg>
                                <span class="truncate">+<?php echo e($memberIncreasePercentage ?? 0); ?>% from last month</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900">TZS <?php echo e(number_format($totalContributions ?? 0)); ?></p>
                            <div class="flex items-center text-sm text-green-600 mt-1">
                                <svg class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                                </svg>
                                <span class="truncate">+<?php echo e($contributionIncreasePercentage ?? 0); ?>% this month</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900"><?php echo e($totalEvents ?? 0); ?></p>
                            <div class="flex items-center text-sm text-gray-600 mt-1">
                                <svg class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                </svg>
                                <span class="truncate">Next: <?php echo e($nextEventDate ?? 'N/A'); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900"><?php echo e($totalResources ?? 0); ?></p>
                            <div class="flex items-center text-sm text-gray-600 mt-1">
                                <svg class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                                </svg>
                                <span class="truncate"><?php echo e($recentResourcesCount ?? 0); ?> new this week</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            ...
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                ...
                <div class="p-6">
                        ...
                        <div class="flex items-start gap-4 group">
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-center gap-3 mb-1">
                                    <h3 class="text-lg font-semibold text-gray-900 truncate"><?php echo e($member->name); ?></h3>
                                ...
                                <div class="flex flex-col sm:flex-row sm:items-center sm:gap-4 text-sm text-gray-600 truncate">
                                    <div class="flex items-center gap-1">
                                        ...
                                        <span class="truncate"><?php echo e($member->email); ?></span>
                                    </div>
                                    <div class="flex items-center gap-1">
                                        <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        </svg>
                                        <span class="truncate"><?php echo e($member->created_at->diffForHumans()); ?></span>
                                    </div>
                                </div>
                                <div class="flex items-center gap-1 mt-2 text-sm text-gray-600">
                                    ...
                                    <span class="truncate"><?php echo e($member->phone ?? 'N/A'); ?></span>
                                </div>
                            </div>
                        </div>
                        <?php if(!$loop->last): ?>
                    ...
                    <?php echo e($recentMembers->links()); ?>
                                ...
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        <div class="flex items-center">
                                            ...
                                            <?php echo e($activity->created_at->format('M j, H:i')); ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="h-8 w-8 rounded-full bg-gray-200 flex items-center justify-center text-gray-700 font-medium">
                                                <?php echo e($activity->user ? strtoupper(substr($activity->user->name, 0, 1)) : 'S'); ?>

                                            </div>
                                            <div class="ml-3">
                                                <p class="text-sm font-medium text-gray-900 truncate"><?php echo e($activity->user ? $activity->user->name : 'System'); ?></p>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 truncate"><?php echo e($activity->description); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                                        <?php if($activity->loggable): ?>
                                        <a href="<?php echo e($activity->loggable_url); ?>" class="text-blue-600 hover:text-blue-900 hover:underline flex items-center">
                                            <svg class="h-4 w-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                            </svg>
                                            <span class="truncate"><?php echo e(class_basename($activity->loggable_type)); ?> #<?php echo e($activity->loggable_id); ?></span>
                                        </a>
                                        <?php else: ?>
            ...
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 gap-4 mt-6">
                        <?php $__currentLoopData = [['Email', '#3b82f6', 40], ['Referral', '#10b981', 42], 
                                ['Paid Search', '#f59e0b', 32], ['(Other)', '#1d4ed8', 38],
                                ['Direct', '#06b6d4', 32], ['Social', '#9ca3af', 28],
                                ['Display', '#6b7280', 27], ['Organic Search', '#22c55e', 10]]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $source): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center">
                            <div class="w-3 h-3 rounded-full mr-2" style="background-color: <?php echo e($source[1]); ?>"></div>
                            <span class="text-sm text-gray-600"><?php echo e($source[0]); ?></span>
                            <span class="ml-auto font-medium"><?php echo e($source[2]); ?></span>
                        </div>
        ...
        <!-- <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
                <div class="flex justify-between items-center mb-4">
                    <h3 class="text-lg font-semibold text-gray-700"><?php echo e($chart[0]); ?></h3>
                    <span class="text-sm" style="color: <?php echo e($chart[2]); ?>"><?php echo e($chart[3]); ?></span>
                </div>
                <div id="<?php echo e($chart[1]); ?>" class="h-20"></div>
                <div class="text-2xl font-bold text-gray-900 mt-2"><?php echo e($chart[4]); ?></div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div> -->
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        <div class="flex justify-between items-center mb-4">
            ...
            <span class="text-sm" style="color: #6366f1">+<?php echo e($memberIncreasePercentage); ?>%</span>
        </div>
        <div id="members-trend" class="h-20"></div>
        <div class="text-2xl font-bold text-gray-900 mt-2"><?php echo e($totalMembers); ?></div>
    </div>
    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        <div class="flex justify-between items-center mb-4">
            ...
            <span class="text-sm" style="color: #10b981">+<?php echo e($contributionIncreasePercentage); ?>%</span>
        </div>
        <div id="contributions-trend" class="h-20"></div>
        <div class="text-2xl font-bold text-gray-900 mt-2">TZS <?php echo e(number_format($totalContributions)); ?></div>
    </div>
    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        <div class="flex justify-between items-center mb-4">
            ...
            <span class="text-sm" style="color: #f59e0b">
                ...
                ?>
                +<?php echo e($eventsGrowth); ?>%
            </span>
        </div>
        <div id="events-trend" class="h-20"></div>
        <div class="text-2xl font-bold text-gray-900 mt-2"><?php echo e($totalEvents); ?></div>
    </div>
    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        <div class="flex justify-between items-center mb-4">
            ...
            <span class="text-sm" style="color: #ef4444">
                ...
                ?>
                +<?php echo e($resourcesGrowth); ?>%
            </span>
        </div>
        <div id="resources-trend" class="h-20"></div>
        <div class="text-2xl font-bold text-gray-900 mt-2"><?php echo e($totalResources); ?></div>
    </div>
</div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6" style="grid-auto-rows: minmax(300px, auto)">
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <?php if(isset($membersPreview) && count($membersPreview)): ?>
                    <div class="mt-8 overflow-x-auto rounded-lg border border-gray-200">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-100">
                                <?php $__currentLoopData = $membersPreview; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="px-4 py-2 text-sm text-gray-900"><?php echo e($member->name); ?></td>
                                    <td class="px-4 py-2 text-sm text-gray-700"><?php echo e($member->phone ?? 'N/A'); ?></td>
                                    <td class="px-4 py-2 text-sm text-gray-700"><?php echo e($member->email); ?></td>
                                    <td class="px-4 py-2 text-sm">
                                        <span class="px-2 py-1 text-xs rounded-full <?php echo e($member->status === 'active' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-600'); ?>">
...
function generateReport(type, format) {
    ...
    const baseUrl = <?php echo json_encode(route('admin.reports.generate', ['type' => '--type--', 'format' => '--format--'])) ?>
        .replace('--type--', type)
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jumuiyakiganjani\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>