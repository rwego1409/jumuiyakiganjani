        ...
        <div class="flex flex-col md:flex-row gap-6 items-start md:items-center justify-between">
            <div class="space-y-1">
                ...
                <p class="text-lg text-gray-600 dark:text-gray-400">
                    Here's your activity overview for <?php echo e(now()->format('F j, Y')); ?>
            ...
            <div class="flex items-center gap-3 bg-white dark:bg-gray-800/50 backdrop-blur-lg border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-2 shadow-sm">
                ...
                <span class="text-sm font-medium text-gray-700 dark:text-gray-300">
                    Updated <?php echo e(now()->format('g:i A')); ?>
                ...
                <div class="flex items-start justify-between space-x-4">
                    <div class="flex-1">
                        <div class="flex items-center gap-3 mb-4">
                            <div class="<?php echo e($card['color']); ?> p-3 rounded-xl shadow-inner">
                        ...
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-1"><?php echo e($card['title']); ?></h3>
                        <p class="text-2xl font-bold text-gray-800 dark:text-gray-200"><?php echo e($card['value']); ?></p>
                    </div>
                    <?php if(isset($card['trend'])): ?>
                    <div class="flex items-center gap-1 text-sm <?php echo e($card['trend'] > 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'); ?>">
                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M<?php echo e($card['trend'] > 0 ? '13 7h8m0 0v8m0-8l-8 8-4-4-6 6' : '13 17H5m0 0V9m0 8l8-8 4 4 6-6'); ?>" />
                        </svg>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800/30 backdrop-blur-lg border border-gray-200 dark:border-gray-700 rounded-2xl p-6 shadow-xl">
                    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-4">
                        ...
                        <div class="flex items-center gap-3">
                            <a href="<?php echo e(route('member.events.index')); ?>" class="inline-flex items-center gap-2 px-4 py-2 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors">
                                <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-white dark:bg-gray-800/30 backdrop-blur-lg border border-gray-200 dark:border-gray-700 rounded-2xl p-6 shadow-xl">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <a href="<?php echo e(route('member.contributions.index')); ?>" class="text-blue-600 dark:text-blue-400 text-sm font-medium hover:text-blue-700 dark:hover:text-blue-300 flex items-center gap-1">
                            View All
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="group flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/20 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-700/40 transition-colors border border-gray-200 dark:border-gray-700">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 class="font-medium text-gray-900 dark:text-white"><?php echo e($contribution->title); ?></h3>
                                    <p class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($contribution->created_at->format('M j, Y - g:i A')); ?></p>
                                </div>
                            </div>
                            <a href="<?php echo e(route('member.contributions.show', $contribution->id)); ?>" class="opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800/30 backdrop-blur-lg border border-gray-200 dark:border-gray-700 rounded-2xl p-6 shadow-xl">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <a href="<?php echo e(route('member.resources.index')); ?>" class="text-blue-600 dark:text-blue-400 text-sm font-medium hover:text-blue-700 dark:hover:text-blue-300 flex items-center gap-1">
                            View All
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                            </svg>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="group flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/20 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-700/40 transition-colors border border-gray-200 dark:border-gray-700">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 class="font-medium text-gray-900 dark:text-white truncate max-w-[160px]"><?php echo e($resource->title); ?></h3>
                                    <p class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($resource->created_at->diffForHumans()); ?></p>
                                </div>
                            </div>
                            <a href="<?php echo e(asset('storage/' . $resource->file_path)); ?>" class="opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300" download>
                                <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-white dark:bg-gray-800/30 backdrop-blur-lg border border-gray-200 dark:border-gray-700 rounded-2xl p-6 shadow-xl">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <a href="<?php echo e(route('member.contributions.create')); ?>" class="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors border border-blue-200 dark:border-blue-800 group">
                            <div class="flex items-center gap-3">
                        ...
                        <a href="<?php echo e(route('member.events.index')); ?>" class="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-xl hover:bg-purple-100 dark:hover:bg-purple-900/30 transition-colors border border-purple-200 dark:border-purple-800 group">
                            <div class="flex items-center gap-3">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        dateClick: (info) => {
            const events = <?php echo json_encode($calendarEvents, 15, 512) ?>.filter(event => 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.member', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jumuiyakiganjani\resources\views/member/dashboard.blade.php ENDPATH**/ ?>