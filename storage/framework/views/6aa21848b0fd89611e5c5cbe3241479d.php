...
<div class="py-4 px-4 sm:py-6 sm:px-0">
  <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
    ...
    <div class="bg-white p-4 sm:p-6 rounded-lg shadow-md">
      ...
      <form id="contributionForm" method="POST" action="<?php echo e(route('clickpesa.ussd-push')); ?>">
        <?php echo csrf_field(); ?>
        ...
        <input type="hidden" name="orderReference" value="<?php echo e('ORD-' . uniqid()); ?>">

        <?php if(auth()->guard()->check()): ?>
          <input type="hidden" name="buyer_email" value="<?php echo e(auth()->user()->email); ?>">
          <input type="hidden" name="buyer_name" value="<?php echo e(auth()->user()->name); ?>">
        <?php endif; ?>
