    ...
    <div class="max-w-6xl mx-auto px-2 sm:px-4 lg:px-8">
        <div class="bg-white/80 dark:bg-purple-900/80 backdrop-blur-md shadow-2xl rounded-2xl border border-pink-200/60 dark:border-purple-700/60 p-4 sm:p-8">
            <div class="mb-6 flex flex-col sm:flex-row items-center gap-2 sm:gap-3 justify-between">
                ...
                <a href="<?php echo e(route('chairperson.members.create')); ?>" class="mt-2 sm:mt-0 inline-flex items-center px-4 py-2 bg-green-100 text-green-700 border border-green-200 rounded-xl font-semibold text-xs sm:text-sm uppercase tracking-widest shadow hover:bg-green-200 hover:text-green-900 focus:outline-none focus:ring-2 focus:ring-green-400 transition">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div class="bg-white/80 dark:bg-gray-700/80 backdrop-blur-md rounded-2xl shadow-2xl border border-pink-200/50 dark:border-pink-900/50 p-6">
                    ...
                    <div class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($stats['total_members']); ?></div>
                </div>

                <div class="bg-white/80 dark:bg-gray-700/80 backdrop-blur-md rounded-2xl shadow-2xl border border-pink-200/50 dark:border-pink-900/50 p-6">
                    <div class="text-xs md:text-sm font-medium text-pink-700 dark:text-pink-300">Active Members</div>
                    <div class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($stats['active_members']); ?></div>
                </div>

                <div class="bg-white/80 dark:bg-gray-700/80 backdrop-blur-md rounded-2xl shadow-2xl border border-pink-200/50 dark:border-pink-900/50 p-6">
                    <div class="text-xs md:text-sm font-medium text-pink-700 dark:text-pink-300">Inactive Members</div>
                    <div class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($stats['inactive_members']); ?></div>
                </div>
            </div>
                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <tr>
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                        <?php echo e($member->joined_date->format('M d, Y')); ?>

                                                    </td>
                                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                        <a href="<?php echo e(route('chairperson.members.show', $member)); ?>" class="text-indigo-600 hover:text-indigo-900">
                                                            <i class="fas fa-eye text-green-500"></i>
                                                        </a>
                                                        <a href="<?php echo e(route('chairperson.members.edit', $member)); ?>" class="bg-green-100 text-green-700 hover:bg-green-200 hover:text-green-900 px-3 py-1 rounded font-semibold shadow focus:outline-none focus:ring-2 focus:ring-green-400 transition mr-2">
                                                            <i class="fas fa-edit text-green-500"></i>
                                                        </a>
                                                        <form action="<?php echo e(route('chairperson.members.destroy', $member)); ?>" method="POST" class="inline-block">
                                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.chairperson', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jumuiyakiganjani\resources\views/chairperson/members/index.blade.php ENDPATH**/ ?>