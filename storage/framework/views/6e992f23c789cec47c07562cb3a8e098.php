            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div class="flex items-center gap-3">
                    <div class="hidden sm:flex items-center text-sm text-gray-500 bg-white px-3 py-2 rounded-lg shadow-sm">
                        ...
                        <?php if(method_exists($chairpersons, 'total')): ?>
                            <?php echo e($chairpersons->total()); ?> Total
                        <?php else: ?>
                            <?php echo e(count($chairpersons)); ?> Total
                        <?php endif; ?>
                    </div>
                    <a href="<?php echo e(route('super_admin.chairpersons.create')); ?>" 
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            <div class="text-sm font-semibold text-gray-900"><?php echo e($chairperson->name ?? 'N/A'); ?></div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-sm text-gray-900"><?php echo e($chairperson->email ?? 'N/A'); ?></span>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-sm text-gray-900"><?php echo e($chairperson->phone ?? 'N/A'); ?></span>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center space-x-2">
                                        <a href="<?php echo e(route('super_admin.chairpersons.show', $chairperson)); ?>" 
                                        ...
                                        <a href="<?php echo e(route('super_admin.chairpersons.edit', $chairperson)); ?>" 
                                        ...
                                        <form action="<?php echo e(route('super_admin.chairpersons.destroy', $chairperson)); ?>" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this chairperson? This action cannot be undone.')">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.super_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jumuiyakiganjani\resources\views/super_admin/chairpersons/index.blade.php ENDPATH**/ ?>