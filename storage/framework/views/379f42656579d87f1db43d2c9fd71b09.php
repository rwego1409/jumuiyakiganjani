        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-xs sm:text-sm">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $jumuiyas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jumuiya): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td class="px-2 sm:px-6 py-4 whitespace-nowrap font-semibold text-gray-900 dark:text-white">
                            <?php echo e($jumuiya->name); ?>

                        </td>
                        <td class="px-2 sm:px-6 py-4 whitespace-nowrap text-gray-700 dark:text-gray-200">
                            <?php echo e($jumuiya->location ?? '-'); ?>

                        </td>
                        <td class="px-2 sm:px-6 py-4 whitespace-nowrap text-gray-700 dark:text-gray-200">
                            <?php echo e($jumuiya->chairperson ? $jumuiya->chairperson->name : '-'); ?>

                        </td>
                        <td class="px-2 sm:px-6 py-4 whitespace-nowrap text-gray-700 dark:text-gray-200">
                            <?php echo e($jumuiya->created_at->format('M d, Y')); ?><br><span class="text-xs text-gray-400"><?php echo e($jumuiya->created_at->diffForHumans()); ?></span>
                        </td>
                        <td class="px-2 sm:px-6 py-4 whitespace-nowrap">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($jumuiya->status === 'pending' ? 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-300' : 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300'); ?>">
                                <?php echo e(ucfirst($jumuiya->status)); ?>

                            </span>
                            <?php if($jumuiya->status === 'pending'): ?>
                                <a href="<?php echo e(route('super_admin.jumuiyas.show', $jumuiya)); ?>" class="ml-2 inline-flex items-center px-2 py-0.5 bg-blue-100 text-blue-700 rounded hover:bg-blue-200 text-xs font-semibold">Review & Verify</a>
                            <?php endif; ?>
                        </td>
                        <td class="px-2 sm:px-6 py-4 whitespace-nowrap">
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr>
                        <td colspan="6" class="px-4 py-2 text-center">No jumuiyas found.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
...
<?php echo $__env->make('layouts.super_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jumuiyakiganjani\resources\views/super_admin/jumuiyas/index.blade.php ENDPATH**/ ?>